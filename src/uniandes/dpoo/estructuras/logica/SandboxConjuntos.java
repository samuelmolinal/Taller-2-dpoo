...
public class SandboxConjuntos
{
    ...
    {
    	NavigableSet<String> inverso = this.arbolCadenas.descendingSet();
    ...
    {
    	Set<String> coleccionSiguientes = this.arbolCadenas.tailSet(cadena, true);
    ...
    public void eliminarCadenaSinMayusculasOMinusculas( String cadena )
    {
    	...
    	for (String elemento: this.arbolCadenas) {
    		if (elemento.toLowerCase().equals(cadenaMin)) {
    ...
    {
    	NavigableSet<String> conjuntoNuevo = new TreeSet<>();
    	for (String cadena: this.arbolCadenas) {
    		conjuntoNuevo.add(cadena.toUpperCase());
    	}
    	this.arbolCadenas = conjuntoNuevo;
    }
    ...
    {
    	TreeSet<String> ordenado = new TreeSet<>(this.arbolCadenas);
        List<String> lista = new ArrayList<>(ordenado);
        Collections.sort(lista, Collections.reverseOrder());
        TreeSet<String> invertido = new TreeSet<>(Collections.reverseOrder());
        invertido.addAll(lista);
